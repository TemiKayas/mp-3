    ...
    return (
        <BigDiv>
            ...
            <h2>To see my other projects...</h2>
                <p>To see my software projects, please check my <a href={"https://github.com/TemiKayas"}>Github</a>. My GitHub page is where I upload and document all of my software projects.</p>
            </SmallDiv>
        </BigDiv>
    );
}